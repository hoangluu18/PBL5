...
<Col xs={24} md={8}>
    <div>
        ...
        <div className="thumbnail-gallery" style={{
            ...
            <div
                className={`${selectedExtraImage === product.mainImage || selectedMainImage === product.mainImage ? "border-danger" : "border-secondary"} border rounded`}
                style={{ 
                    width: '70px', 
                    height: '70px', 
                    cursor: 'pointer', 
                ...
                onClick={() => {
                    setSelectedMainImage(product.mainImage);
                    setSelectedExtraImage(product.mainImage);
                }}
            >
                <img
            ...
            {product.images && product.images.map((image, index) => (
                <div
                    key={index}
                    className={`${selectedExtraImage === image ? "border-danger" : "border-secondary"} border rounded`}
                    style={{ 
                        width: '70px', 
                        height: '70px', 
                        cursor: 'pointer', 
                    ...
                    onClick={() => handleHoverAndClickImage({ target: { src: image } })}
                >
                    <img
                        src={image}
