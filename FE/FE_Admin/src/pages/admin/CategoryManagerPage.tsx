...
const CategoriesManagement = () => {
    ...
    {
        title: 'Tên danh mục', // Đã Việt hóa
        dataIndex: 'name',
        key: 'name',
...
>
    ...
    >
            ...
            <Col span={12}>
                <Form.Item
                    ...
                    rules={[
                        ...
                        { max: 128, message: 'Tên không được vượt quá 128 ký tự!' }
                    ]}
                >
            ...
            <Col span={12}>
                <Form.Item
                    ...
                    rules={[
                        ...
                        { max: 64, message: 'Đường dẫn không được vượt quá 64 ký tự!' },
                        { pattern: /^[a-z0-9-]+$/, message: 'Đường dẫn chỉ được chứa chữ thường, số và dấu gạch ngang!' }
                    ]}
                >
                    <Input placeholder="vd: dien-tu, thoi-trang" />
                </Form.Item>
            </Col>
        </Row>
        ...
        <Form.Item
            ...
            label="Hình ảnh"
        >
            <Input placeholder="Tên file hình ảnh hoặc URL" />
        </Form.Item>
