package com.pbl5.client.service.aws.s3;
...
public class S3StorageService {
    ...
    public String uploadFile(MultipartFile file) throws IOException {
        ...
        String uniqueFilename = "avatars/" + UUID.randomUUID().toString() + extension;
    ...
    public void deleteFile(String fileUrl) {
        if (fileUrl != null && !fileUrl.isEmpty()) {
            try {
                ...
                System.out.println("Deleting file with key: " + key); // Log để debug
